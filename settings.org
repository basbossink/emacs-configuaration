...
** Sift searching
#+begin_src emacs-lisp :tangle yes
(global-set-key (kbd "C-S-f") 'sift-regexp)
(global-set-key (kbd "<f6>") 'sift-regexp-cs)
#+end_src
** Kill other buffers
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
(setq ledger-binary-path "C:\\Users\\user\\PortableApps\\ledger\\ledger.exe")
#+end_src
...
#+end_src
* Custom functions
** Sift through C# files only
#+begin_src emacs-lisp :tangle yes
(defun sift-regexp-cs (regexp dir)
  (interactive "sRegex: \nDDirectory: ")
  (sift-regexp regexp dir '("-x" "cs")))
#+end_src
