...
(add-to-list "--decorate" magit-log-arguments)
(add-to-list "-n256" magit-log-arguments)
#+end_src
** Commit hook setup
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
 ...
 (setq mingus-mode-line-string-max 180)
...
(setq alchemist-hooks-test-on-save t)
 #+end_src
** PowerShell
*** Do not load profile to avoid interference from ssh-agent and posh-git
  #+begin_src emacs-lisp :tangle yes
  (setq explicit-powershell.exe-args  '("-NoProfile" "-Command" "-"))
  #+end_src
