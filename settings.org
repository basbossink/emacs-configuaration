...
#+end_src
** Expand region
- Control = expands the region
- Control Shift = contracts the region
#+begin_src emacs-lisp :tangle yes
  (require 'expand-region)
  (define-key prog-mode-map (kbd "C-=") 'er/expand-region)
  (define-key prog-mode-map (kbd "C-+") (kbd "C-u - 1 C-="))
#+end_src
** Smart forward
...
#+end_src
*** Align regexp should use spaces iso tabs
#+begin_src emacs-lisp :tangle yes
...
#+end_src
*** Copy content of the system clipboard to the kill ring before performing a kill in Emacs
Save whatever’s in the current (system) clipboard before
replacing it with the Emacs’ text.
[[https://github.com/dakrone/eos/blob/master/eos.org][See here]] for details.
#+begin_src emacs-lisp :tangle yes
...
#+end_src
** Set up org-mode export for reveal.js presentations
#+begin_src emacs-lisp :tangle yes
(require 'ox-reveal)
(setq org-reveal-root "file:///home/bas/projects/reveal.js")
#+end_src
** Org journal mode
*** Initialize
#+begin_src emacs-lisp :tangle yes
...
*** Set preferences
#+begin_src emacs-lisp :tangle yes
  (setq org-journal-dir (expand-file-name "~/Dropbox/Personal/journals/2017"))
...
#+end_src
*** Enable auto-fill mode for yaml mode
#+begin_src emacs-lisp :tangle yes
(add-hook 'yaml-mode-hook 'turn-on-auto-fill)
#+end_src
*** Show auto-fill column
#+begin_src emacs-lisp :tangle yes
(require 'fill-column-indicator)
(add-hook 'auto-fill-mode-hook 'fci-mode)
#+end_src
** SQL mode
*** Login defaults
#+begin_src emacs-lisp :tangle yes
(setq sql-postgres-login-params
      '((user :default "postgres")
        ...
        (port :default 5432)))
#+end_src
*** Don't truncate lines of the query output
#+begin_src emacs-lisp :tangle yes
